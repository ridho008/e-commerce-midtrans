                        ...
                        @if (session('cart'))
                            @foreach (session('cart') as $id => $item)
                                ...
                                <tr rowId="{{ $id }}">
                                        ...
                                        <form action="{{ route('update.sopping.cart') }}" method="post">
                                            <div class="input-group input-group-sm mb-3">
                                                ...
                                                <input type="number" name="qty" min="1" max="10"
                                                    ...
                                                    value="{{ $item['qty'] }}">
                                                <button type="submit" class="btn btn-outline-primary update-product-qty"
                                    ...
                                    <td data-th="Subtotal" class="text-center">{{ number_format($subTotal, 0, ',', '.') }}
                                    </td>
                                    <td class="actions">
                                        <a href="#" data-id="{{ $id }}"
                                            class="btn btn-outline-danger btn-sm delete-product">Delete</a>
                                    </td>
                                </tr>
                            @endforeach
                        @else
                            <tr>
                                <td colspan="4" class="text-center"><small>not found</small></td>
                            </tr>
                        @endif
                        <tr>
                        ...
                        <form action="{{ route('checkout.cart') }}" method="post">
                                ...
                                <td>
                                    <div class="mb-3">
                                        ...
                                        <input type="text" value="{{ old('fullname') }}"
                                            class="@error('fullname') is-invalid @enderror form-control" name="fullname"
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="number" name="phone" placeholder="+62xxx"
                            ...
                            <tr>
                                <td colspan="5" class="text-right">
                                    <a href="{{ url('/products') }}" class="btn btn-primary"><i
